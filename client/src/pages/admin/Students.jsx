      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500 text-sm">Manage all students, admission records and profiles.</p>
          </div>
          <button 
          ...
          <div className="bg-white border border-slate-100 shadow-sm w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl">
            ...
            <form onSubmit={onSubmit} className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm text-slate-500">Admission Number</label>
                  <input name="admissionNumber" onChange={onChange} className="w-full bg-white border border-slate-200 text-slate-800 rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10" required />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <input name="studentClass" onChange={onChange} className="w-full bg-white border border-slate-200 text-slate-800 rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10" required />
                </div>
              </div>
              <div className="pt-4 flex gap-3">
                ...
                <button type="submit" className="flex-1 bg-orange-600 hover:bg-orange-500 text-slate-800 px-4 py-2 rounded-xl transition-all shadow-lg shadow-orange-600/20">Add Student</button>
              </div>
            </form>
          </div>
        </div>
